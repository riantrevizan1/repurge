...
**Repurge** is a Node.js CLI tool that automatically detects and removes garbage files accumulated by AI coding agents, git workflows, and modern development tools.
...
- 🛡️ **Safety First** — Never deletes without confirmation
...
repurge clean --skip-confirm # Don't ask for confirmation (careful!)
```
...
▸ Git Worktrees (2.1 GB)
  ├─ ~/.git/worktrees/feature/api            650 MB    🟢 Merged & safe
  ├─ ~/.git/worktrees/old-experiment         800 MB    🟡 Review (stale)
  └─ ~/.git/worktrees/wip/refactor           650 MB    🔴 Has uncommitted changes
...
[Open an issue](https://github.com/riantrevizan1/repurge/issues)
...
Made with ❤️ by developers using AI coding agents.
